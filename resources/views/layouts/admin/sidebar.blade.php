        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="sidebar-menu">
                <ul class="navbar-nav pt-lg-3">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/dashboard') }}" onclick="highlightFeature(this)">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#navbar-base" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button" aria-expanded="false" onclick="highlightFeature(this)">
                            <span class="nav-link-icon d-md-none d-lg-inline-block">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/data_karyawan') }}" onclick="highlightFeature(this)">
                            <span class="nav-link-icon d-md-none d-lg-inline-block">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/rekap_absen') }}" onclick="highlightFeature(this)">
                            <span class="nav-link-icon d-md-none d-lg-inline-block">
                                <!-- Download SVG icon from http://tabler-icons.io/i/home -->
...
<script>
    function highlightFeature(element) {
        // Hapus semua kelas 'active' dari item navbar lainnya
        var navbarItems = document.querySelectorAll('.nav-link');
        navbarItems.forEach(function(item) {
            item.classList.remove('active');
        });

        // Tambahkan kelas 'active' ke item navbar yang sedang diklik
